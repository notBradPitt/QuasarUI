...
def init_custom_nodes():
    load_custom_node(os.path.join(os.path.join(os.path.dirname(os.path.realpath(__file__)), "quasar_extras"), "nodes_latent.py"))
    ...
    load_custom_node(os.path.join(os.path.join(os.path.dirname(os.path.realpath(__file__)), "quasar_extras"), "nodes_freelunch.py"))
    load_custom_node(os.path.join(os.path.join(os.path.dirname(os.path.realpath(__file__)), "quasar_extras"), "nodes_custom_sampler.py"))
    load_custom_nodes()
