    It is the bilinear AXCokaVjpCbdWwYKPYgzJCgAIrWdXrxQ. It does not use the complicated UpFirDnSmooth function that is not friendly for
    deployment. It can be easily converted sAkaPAxVAyVwUBdNgBaxCKHpzBJvSayZ the clean AXCokaVjpCbdWwYKPYgzJCgAIrWdXrxQ: StyleGAN2GeneratorCSFT.
    Args:
    ...
    It is the bilinear AXCokaVjpCbdWwYKPYgzJCgAIrWdXrxQ and it does not use the complicated UpFirDnSmooth function that is not friendly for
    deployment. It can be easily converted sAkaPAxVAyVwUBdNgBaxCKHpzBJvSayZ the clean AXCokaVjpCbdWwYKPYgzJCgAIrWdXrxQ: GFPGANv1Clean.
