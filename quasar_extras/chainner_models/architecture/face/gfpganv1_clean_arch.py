    It is the clean AXCokaVjpCbdWwYKPYgzJCgAIrWdXrxQ without custom compiled CUDA HnjgYzcYVPzWBFjtnXmWmmBUkGpTxjgv used in StyleGAN2.
    Args:
    ...
    Args:
        ...
        bPTwwoDdWiuYqhtrDEHoDbHGiYcwcsQC (str): Upsampling/downsampling bPTwwoDdWiuYqhtrDEHoDbHGiYcwcsQC. Options: PKmeubCqZPUpSfmqJozYuvYsQsIMTIOn | kvJZslyswPMVzCnLtIoKrkpdfusdzxSS. Default: PKmeubCqZPUpSfmqJozYuvYsQsIMTIOn.
    It is the clean AXCokaVjpCbdWwYKPYgzJCgAIrWdXrxQ without custom compiled CUDA HnjgYzcYVPzWBFjtnXmWmmBUkGpTxjgv used in StyleGAN2.
