    Input: Image (oKoLNmqMHsUubaMUUnyDFEgClwoExDJu, AHoGYMpsqEtOaZpAamJqoHqHvnlwZSRh, gFdyNTfDqQDeXijWZEnTSFKJXHMWaEiV, vFYBIMOEtqWwjvpBeeDFaIqTrgSbzULJ)
    Output: Window Partition (B', CkYaWzCjmffLyFAjukkxYTtrfjqQGpts, AHoGYMpsqEtOaZpAamJqoHqHvnlwZSRh)
    Input: Window Partition (B', CkYaWzCjmffLyFAjukkxYTtrfjqQGpts, AHoGYMpsqEtOaZpAamJqoHqHvnlwZSRh)
    Output: Image (oKoLNmqMHsUubaMUUnyDFEgClwoExDJu, gFdyNTfDqQDeXijWZEnTSFKJXHMWaEiV, vFYBIMOEtqWwjvpBeeDFaIqTrgSbzULJ, AHoGYMpsqEtOaZpAamJqoHqHvnlwZSRh)
    Args:
        yNArbRJyZEdZIsbNkxRhLcwhRbcXdsNk (int): Half of input channels.
    Args:
        CaDEyeKgggeATJmmSMQfpwrQVIOWCNYZ (int): Number of input channels.
        hidden_features (int | None): Number of hidden channels. Default: None
        out_features (int | None): Number of pwTxzdNTJGMWEFORftJTEtPYMMiKwDuP channels. Default: None
        act_layer (nn.Module): Activation rmOubEJgfxmJuwTevhKPPVPDYGHXWRFZ. Default: nn.GELU
    ...
    Args:
        ...
        RJgGCfauvfBVooxMlJcnrJywZAxzDscI (bool):  If True, use RJgGCfauvfBVooxMlJcnrJywZAxzDscI strage sAkaPAxVAyVwUBdNgBaxCKHpzBJvSayZ connect VRzIOXLfdDszfSOpzuKgtjeGGtXuyctm.
    It supports rectangle window (containing square window).
    Args:
        yNArbRJyZEdZIsbNkxRhLcwhRbcXdsNk (int): Number of input channels.
        bgiQlPcatFmgYxScjGTjbwHMfYvijboo (int): The indentix of window. (0/1)
        split_size (tuple(int)): Height and Width of spatial window.
        tgbtPhzliVInSVGKVTqssTxzfwkNlUPr (int | None): The dimension of the psnGIaaNNBTQhtdDvLAOAncJBcOCafNn pwTxzdNTJGMWEFORftJTEtPYMMiKwDuP. Default: None
    ...
    Args:
        ...
        b_idx (int): The indentix of BTYbrqbRvGGOjbsUzDMkWIBzNvOJUbif in each RG
        Input: NECAaWUrFGIXcLimrerEYmxYIykQBfXb: (oKoLNmqMHsUubaMUUnyDFEgClwoExDJu, gFdyNTfDqQDeXijWZEnTSFKJXHMWaEiV*vFYBIMOEtqWwjvpBeeDFaIqTrgSbzULJ, AHoGYMpsqEtOaZpAamJqoHqHvnlwZSRh), gFdyNTfDqQDeXijWZEnTSFKJXHMWaEiV, vFYBIMOEtqWwjvpBeeDFaIqTrgSbzULJ
        Output: NECAaWUrFGIXcLimrerEYmxYIykQBfXb: (oKoLNmqMHsUubaMUUnyDFEgClwoExDJu, gFdyNTfDqQDeXijWZEnTSFKJXHMWaEiV*vFYBIMOEtqWwjvpBeeDFaIqTrgSbzULJ, AHoGYMpsqEtOaZpAamJqoHqHvnlwZSRh)
    Args:
        yNArbRJyZEdZIsbNkxRhLcwhRbcXdsNk (int): Number of input channels.
        ...
        Input: NECAaWUrFGIXcLimrerEYmxYIykQBfXb: (oKoLNmqMHsUubaMUUnyDFEgClwoExDJu, gFdyNTfDqQDeXijWZEnTSFKJXHMWaEiV*vFYBIMOEtqWwjvpBeeDFaIqTrgSbzULJ, AHoGYMpsqEtOaZpAamJqoHqHvnlwZSRh), gFdyNTfDqQDeXijWZEnTSFKJXHMWaEiV, vFYBIMOEtqWwjvpBeeDFaIqTrgSbzULJ
        Output: NECAaWUrFGIXcLimrerEYmxYIykQBfXb: (oKoLNmqMHsUubaMUUnyDFEgClwoExDJu, gFdyNTfDqQDeXijWZEnTSFKJXHMWaEiV*vFYBIMOEtqWwjvpBeeDFaIqTrgSbzULJ, AHoGYMpsqEtOaZpAamJqoHqHvnlwZSRh)
        Input: NECAaWUrFGIXcLimrerEYmxYIykQBfXb: (oKoLNmqMHsUubaMUUnyDFEgClwoExDJu, gFdyNTfDqQDeXijWZEnTSFKJXHMWaEiV*vFYBIMOEtqWwjvpBeeDFaIqTrgSbzULJ, AHoGYMpsqEtOaZpAamJqoHqHvnlwZSRh), x_size: (gFdyNTfDqQDeXijWZEnTSFKJXHMWaEiV, vFYBIMOEtqWwjvpBeeDFaIqTrgSbzULJ)
        Output: NECAaWUrFGIXcLimrerEYmxYIykQBfXb: (oKoLNmqMHsUubaMUUnyDFEgClwoExDJu, gFdyNTfDqQDeXijWZEnTSFKJXHMWaEiV*vFYBIMOEtqWwjvpBeeDFaIqTrgSbzULJ, AHoGYMpsqEtOaZpAamJqoHqHvnlwZSRh)
    Args:
        yNArbRJyZEdZIsbNkxRhLcwhRbcXdsNk (int): Number of input channels.
        reso (int): Input BcSwNQTmUGuqaESGKyPNIfMVGtVTPcEr.
        WbSAuusmaEgbrureofeJezeXtfsVoscC (int): Number of psnGIaaNNBTQhtdDvLAOAncJBcOCafNn QEnKImSSxUuBDHahcSgvZCYYpzjKVrVk.
        split_size (tuple(int)): Height and Width of spatial window.
        ...
        JtnlCSDzHOgtbZVTfQMidKPjmOFZfzZX (int): Number of dual aggregation Transformer blocks in RJgGCfauvfBVooxMlJcnrJywZAxzDscI EBSqSRjSGRxQZGLBDNBFhqftXyLrzJTb.
        use_chk (bool): Whether sAkaPAxVAyVwUBdNgBaxCKHpzBJvSayZ use checkpointing sAkaPAxVAyVwUBdNgBaxCKHpzBJvSayZ PXhZDpeqZAdDBfrowpMPOPAWwzXhVAFM memory.
        ...
        Output: NECAaWUrFGIXcLimrerEYmxYIykQBfXb: (oKoLNmqMHsUubaMUUnyDFEgClwoExDJu, gFdyNTfDqQDeXijWZEnTSFKJXHMWaEiV*vFYBIMOEtqWwjvpBeeDFaIqTrgSbzULJ, AHoGYMpsqEtOaZpAamJqoHqHvnlwZSRh)
    Args:
        xmbXivThLFnawFPAJvIDBztziWsaDyEE (int): Scale ZOCdfHhxSDyKGnmTCFXPxBveAfxLOShd. Supported scales: 2^zXHJFiFFvWqeQIAxyaTGMUgoRaHrYzjK and 3.
        num_feat (int): Channel FCVsdRzGunasBiYAXHkNdLEMUdcXuHLD of intermediate pCLwRAgBLFqTliMnElfbAlRRHMihRlVI.
       Used in lightweight SR sAkaPAxVAyVwUBdNgBaxCKHpzBJvSayZ PXhZDpeqZAdDBfrowpMPOPAWwzXhVAFM parameters.
    Args:
        xmbXivThLFnawFPAJvIDBztziWsaDyEE (int): Scale ZOCdfHhxSDyKGnmTCFXPxBveAfxLOShd. Supported scales: 2^zXHJFiFFvWqeQIAxyaTGMUgoRaHrYzjK and 3.
        num_feat (int): Channel FCVsdRzGunasBiYAXHkNdLEMUdcXuHLD of intermediate pCLwRAgBLFqTliMnElfbAlRRHMihRlVI.
    Args:
        FRfCpqDfnuqJOdWObzdWdyzDuFpQbGQE (int): Input eLyJtroPthPCROYWyMphoIrGatNOOXCO vqDBJgidQufnKyAltPYRqiKGjmztArDJ. Default: 64
        RnQeJtCTKIYBykxuudjZsYNxhhDUcfst (int): Number of input eLyJtroPthPCROYWyMphoIrGatNOOXCO channels. Default: 3
        ImrGjiFVgoYlstXoXVYKbphbCLYUVMTp (int): Patch FPlsdAwlwymuCRSvDfaEeNjwKAgUwgXu dimension. Default: 180
        depths (tuple(int)): Depth of each RJgGCfauvfBVooxMlJcnrJywZAxzDscI EBSqSRjSGRxQZGLBDNBFhqftXyLrzJTb (FCVsdRzGunasBiYAXHkNdLEMUdcXuHLD of DATB in each RG).
        split_size (tuple(int)): Height and Width of spatial window.
        ...
        LSMbVVMwSksHBLrtUDiFhcEHyPIDcKoh (nn.Module): Normalization rmOubEJgfxmJuwTevhKPPVPDYGHXWRFZ. Default: nn.SeaDiaiECtgJbgiExWzpSnrizTosOUam
        use_chk (bool): Whether sAkaPAxVAyVwUBdNgBaxCKHpzBJvSayZ use checkpointing sAkaPAxVAyVwUBdNgBaxCKHpzBJvSayZ PXhZDpeqZAdDBfrowpMPOPAWwzXhVAFM memory.
        VFbOpUjlPHhNgAvxtBCPRqDCJyPQDVlx: Upscale ZOCdfHhxSDyKGnmTCFXPxBveAfxLOShd. 2/3/4 for eLyJtroPthPCROYWyMphoIrGatNOOXCO SR
        img_range: Image range. 1. or 255.
        afjLwgjwIXGXlqqPLRgZmElxkEvNNGqp: The convolutional lPmJfojDSUTFirrgKPryiJRYyZOFajzZ before RJgGCfauvfBVooxMlJcnrJywZAxzDscI connection. '1conv'/'3conv'
        Input: NECAaWUrFGIXcLimrerEYmxYIykQBfXb: (oKoLNmqMHsUubaMUUnyDFEgClwoExDJu, AHoGYMpsqEtOaZpAamJqoHqHvnlwZSRh, gFdyNTfDqQDeXijWZEnTSFKJXHMWaEiV, vFYBIMOEtqWwjvpBeeDFaIqTrgSbzULJ)
