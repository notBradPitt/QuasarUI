...
class SaveAudio:
    ...
    def INPUT_TYPES(s):
        return {"required": { "audio": ("AUDIO", ),
                              "filename_prefix": ("STRING", {"default": "audio/QuasarUI"})},
    ...
    def save_audio(self, audio, filename_prefix="QuasarUI", prompt=None, extra_pnginfo=None):
