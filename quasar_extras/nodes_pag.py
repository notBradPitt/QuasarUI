...
#My modified one here is more basic but has less chances of breaking with QuasarUI updates.
...
class PerturbedAttentionGuidance:
    ...
    def patch(self, model, scale):
        ...
        def post_cfg_function(args):
            ...
            model_options = quasar.model_patcher.set_model_options_patch_replace(model_options, perturbed_attention, "attn1", unet_block, unet_block_id)
            (pag,) = quasar.samplers.calc_cond_batch(model, [cond], x, sigma, model_options)
