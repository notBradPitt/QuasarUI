...
from quasar.ldm.modules.diffusionmodules.mmdit import (
    Mlp,
    TimestepEmbedder,
    PatchEmbed,
    RMSNorm,
)
from quasar.ldm.modules.diffusionmodules.util import timestep_embedding
...
class HunYuanControlNet(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.norm = norm
        self.dtype = dtype
        self.latent_format = quasar.latent_formats.SDXL
    ...
    def forward(
        ...
        **kwarg,
        ...
        padding = quasar.ops.cast_to_input(self.text_embedding_padding, text_states)
