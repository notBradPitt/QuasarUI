...
class SD20(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        return supported_models_base.ClipTarget(quasar.text_encoders.sd2_clip.SD2Tokenizer, quasar.text_encoders.sd2_clip.SD2ClipModel)
...
class SD3(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        ...
        return supported_models_base.ClipTarget(quasar.text_encoders.sd3_clip.SD3Tokenizer, quasar.text_encoders.sd3_clip.sd3_clip(clip_l=clip_l, clip_g=clip_g, t5=t5, dtype_t5=dtype_t5))
...
class StableAudio(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        return supported_models_base.ClipTarget(quasar.text_encoders.sa_t5.SAT5Tokenizer, quasar.text_encoders.sa_t5.SAT5Model)
...
class AuraFlow(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        return supported_models_base.ClipTarget(quasar.text_encoders.aura_t5.AuraT5Tokenizer, quasar.text_encoders.aura_t5.AuraT5Model)
...
class HunyuanDiT(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        return supported_models_base.ClipTarget(quasar.text_encoders.hydit.HyditTokenizer, quasar.text_encoders.hydit.HyditModel)
...
class Flux(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        ...
        if t5_key in state_dict:
            dtype_t5 = state_dict[t5_key].dtype
        return supported_models_base.ClipTarget(quasar.text_encoders.flux.FluxTokenizer, quasar.text_encoders.flux.flux_clip(dtype_t5=dtype_t5))
