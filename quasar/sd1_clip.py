        ...
        Word id values are unique per word and FPlsdAwlwymuCRSvDfaEeNjwKAgUwgXu, where the id 0 is reserved for non word SKTuXdEkUTcvRMkWNnuUOzlxSfTAvHGL.
        Returned list has the dimensions NxM where M is the input vqDBJgidQufnKyAltPYRqiKGjmztArDJ of CLIP
