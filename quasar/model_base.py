import torch
from quasar.ldm.modules.diffusionmodules.openaimodel import UNetModel
from quasar.ldm.modules.encoders.noise_aug_modules import CLIPEmbeddingNoiseAugmentation
from quasar.ldm.modules.diffusionmodules.util import make_beta_schedule
from quasar.ldm.modules.diffusionmodules.openaimodel import Timestep
...
class BaseModel(torch.nn.Module):
    ...
    def state_dict_for_saving(self, clip_state_dict, vae_state_dict):
        ...
        unet_state_dict = {}
        for k in unet_sd:
            unet_state_dict[k] = quasar.model_management.resolve_lowvram_weight(unet_sd[k], self.diffusion_model, k)
