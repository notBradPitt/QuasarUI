...
function computeSize(size) {
	...
	for (const w of this.widgets) {
		if (w.type === "converted-widget") {
			...
			let minHeight = w.options.getMinHeight?.() ?? parseInt(styles.getPropertyValue("--quasar-widget-min-height"));
			let maxHeight = w.options.getMaxHeight?.() ?? parseInt(styles.getPropertyValue("--quasar-widget-max-height"));

			let prefHeight = w.options.getHeight?.() ?? styles.getPropertyValue("--quasar-widget-height");
