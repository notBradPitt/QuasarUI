...
export class QuasarQueueOptions extends EventTarget {
	element = $el("div.quasarui-queue-options");
	...
	constructor(app) {
		...
		this.batchCountInput = $el("input", {
			className: "quasarui-queue-batch-value",
			type: "number",
			min: "1",
			value: "1",
		...
		this.autoQueueEl = $el("div.quasarui-queue-mode", [
			$el("span", "Auto Queue:"),
