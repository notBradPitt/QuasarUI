 ...
 *    tooltip?: string;
 *    enabled?: boolean;
 *    action?: (e: Event, btn: QuasarButton) => void,
 *    classList?: import("../utils.js").ClassList,
 * 	  visibilitySetting?: { id: string, showValue: any },
 * 	  app?: import("../../app.js").QuasarApp
 * }} QuasarButtonProps
 */
export class QuasarButton {
	#over = 0;
	#popupOpen = false;
	isOver = false;	
	...
	/**
	 * @type {import("./popup.js").QuasarPopup}
	 */
	popup;

	/**
	 * @param {QuasarButtonProps} opts
	 */
	constructor({
		icon,
		overIcon,
	...
	/**
	 *
	 * @param { import("./popup.js").QuasarPopup } popup
