...
export class QuasarPopup extends EventTarget {
	element = $el("div.quasarui-popup");
	...
	constructor(
		...
		this.classList = prop(this, "classList", classList, () => applyClasses(this.element, this.classList, "quasarui-popup", horizontal));
