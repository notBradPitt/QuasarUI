	...
	"light": {
		...
		"colors": {
			...
			"quasar_base": {
				"fg-color": "#222",
				"bg-color": "#DDD",
				"quasar-menu-bg": "#F5F5F5",
				"quasar-input-bg": "#C9C9C9",
				"input-text": "#222",
				"descrip-text": "#444",
				"drag-text": "#555",
				"error-text": "#F44336",
	...
	"solarized": {
		...
		"colors": {
			...
			"quasar_base": {
				...
				"quasar-menu-bg": "#073642", // Base02
				"quasar-input-bg": "#002b36", // Base03
	...
	"arc": {
		...
		"colors": {
			...
			"quasar_base": {
			  "fg-color": "#fff",
			  "bg-color": "#2b2f38",
			  "quasar-menu-bg": "#242730",
			  "quasar-input-bg": "#2b2f38",
			  "input-text": "#ddd",
			  "descrip-text": "#b2b7bd",
			  "drag-text": "#ccc",
			  "error-text": "#ff4444",
	...
	"nord": {
		...
		"colors": {
			...
			"quasar_base": {
			  "fg-color": "#e5eaf0",
			  "bg-color": "#2e3440",
			  "quasar-menu-bg": "#161b22",
			  "quasar-input-bg": "#2e3440",
			  "input-text": "#bcc2c8",
			  "descrip-text": "#999",
			  "drag-text": "#ccc",
			  "error-text": "#ff4444",
	...
	"github": {
		...
		"colors": {
			...
			"quasar_base": {
			  "fg-color": "#e5eaf0",
			  "bg-color": "#161b22",
			  "quasar-menu-bg": "#13171d",
			  "quasar-input-bg": "#161b22",
			  "input-text": "#bcc2c8",
			  "descrip-text": "#999",
			  "drag-text": "#ccc",
			  "error-text": "#ff4444",
...
const id = "Quasar.ColorPalette";
const idCustomColorPalettes = "Quasar.CustomColorPalettes";
...
app.registerExtension({
	...
	addCustomNodeDefs(node_defs) {
		...
		const getColorPaletteTemplate = async () => {
			...
			for (const key in defaultColorPalette.colors.quasar_base) {
				if (!colorPalette.colors.quasar_base[key]) {
					colorPalette.colors.quasar_base[key] = "";
				}
			}
		...
		const loadColorPalette = async (colorPalette) => {
			...
			if (colorPalette.colors) {
				...
				// Sets the color of QuasarUI elements
				if (colorPalette.colors.quasar_base) {
					const rootStyle = document.documentElement.style;
					for (const key in colorPalette.colors.quasar_base) {
						rootStyle.setProperty('--' + key, colorPalette.colors.quasar_base[key]);
					}
				}
