...
const id = "Quasar.NodeTemplates";
const file = "quasar.templates.json";

class ManageTemplates extends QuasarDialog {
	constructor() {
		super();
		this.load().then((v) => {
			this.templates = v;
		...
		this.element.classList.add("quasar-manage-templates");
		this.draggedEl = null;
						...
						$el(
							"div",
							{
								...
								style: {
									...
									gap: "5px",
									backgroundColor: "var(--quasar-menu-bg)"
								},
								ondragstart: (e) => {
										...
										$el("input", {
											...
											onchange: (e) => {
												...
												this.saveVisualCue = setTimeout(function () {
													...
													el.style.backgroundColor = 'var(--quasar-input-bg)';
												}, 15);
											},
											onkeypress: (e) => {
												var el = e.target;
