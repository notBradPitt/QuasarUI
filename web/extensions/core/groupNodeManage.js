...
export class ManageGroupDialog extends QuasarDialog {
	...
	constructor(app) {
		super();
		this.app = app;
		this.element = $el("dialog.quasar-group-manage", {
	...
	show(type) {
		...
		this.innerNodesList = $el("ul.quasar-group-manage-list-items");
		this.widgetsPage = $el("section.quasar-group-manage-node-page");
		this.inputsPage = $el("section.quasar-group-manage-node-page");
		this.outputsPage = $el("section.quasar-group-manage-node-page");
		...
		const outer = $el("div.quasar-group-manage-outer", [
			$el("header", [
				$el("h2", "Group Nodes"),
				$el(
					"select",
			...
			$el("main", [
				$el("section.quasar-group-manage-list", this.innerNodesList),
				$el("section.quasar-group-manage-node", [
					$el(
						"header",
			...
			$el("footer", [
				...
				$el("button.quasar-btn", { onclick: () => this.element.close() }, "Close"),
			]),
		]);
