	...
	registerCustomNodes(app) {
		class RerouteNode {
			...
			static setDefaultTextVisibility(visible) {
				...
				if (visible) {
					localStorage["Quasar.RerouteNode.DefaultVisibility"] = "true";
				} else {
					delete localStorage["Quasar.RerouteNode.DefaultVisibility"];
				}
			}
		}

		// Load default visibility
		RerouteNode.setDefaultTextVisibility(!!localStorage["Quasar.RerouteNode.DefaultVisibility"]);
