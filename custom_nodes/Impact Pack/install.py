...
quasar_path = os.path.join(os.path.dirname(__file__), '..', '..')
...
try:
    ...
    def ensure_pip_packages_last():
        ...
        try:
            ...
            try:
                ...
                print(f"QuasarUI-Impact-Pack: failed to install 'opencv-python'. Please, install manually.")
    ...
    print("[QuasarUI-Impact-Pack]: Dependency installation has failed. Please install manually.")
    print(e)
