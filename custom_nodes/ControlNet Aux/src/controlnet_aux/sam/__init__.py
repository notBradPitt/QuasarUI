...
class SamDetector:
    ...
    def to(self, device):
        ...
        model.train(False) #Update attention_bias in https://github.com/Fannovel16/quasarui_controlnet_aux/blob/main/src/controlnet_aux/segment_anything/modeling/tiny_vit_sam.py#L251
