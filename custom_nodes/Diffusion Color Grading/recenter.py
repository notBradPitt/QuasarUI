...
ORIGINAL_SAMPLE = quasar.sample.sample
ORIGINAL_SAMPLE_CUSTOM = quasar.sample.sample_custom
...
quasar.sample.sample = hijack(ORIGINAL_SAMPLE)
quasar.sample.sample_custom = hijack(ORIGINAL_SAMPLE_CUSTOM)
