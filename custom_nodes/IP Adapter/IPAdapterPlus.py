...
from quasar.clip_vision import load as load_clip_vision
from quasar.sd import load_lora_for_models
import quasar.utils
...
class IPAdapterUnifiedLoader:
    ...
    def load_models(self, model, preset, lora_strength=0.0, provider="CPU", ipadapter=None):
        ...
        is_sdxl = isinstance(model.model, (quasar.model_base.SDXL, quasar.model_base.SDXLRefiner, quasar.model_base.SDXL_instructpix2pix))
        ...
        if lora_pattern is not None:
            ...
            if lora_model is None:
                lora_model = quasar.utils.load_torch_file(lora_file, safe_load=True)
