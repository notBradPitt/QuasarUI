...
#from https://github.com/huchenlei/QuasarUI-layerdiffuse/blob/151f7460bbc9d7437d4f0010f21f80178f7a84a6/layered_diffusion.py#L34-L96
...
def calculate_weight_adjust_channel(func):
    """Patches QuasarUI's LoRA weight application to accept multi-channel inputs."""
        ...
        for p in patches:
            ...
            if patch_type == "diff":
                ...
                if all(
                    ...
                    new_diff = alpha * quasar.model_management.cast_to_device(
