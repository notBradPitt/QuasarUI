...
class CR_CycleModels:
    ...
    def cycle_models(self, mode, model, clip, model_list, frame_interval, loops, current_frame,):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Cycler-Nodes#cr-cycle-models"
        ...
        if mode == "Off":
            ...
            if current_frame == 0:
                ...
                out = quasar.sd.load_checkpoint_guess_config(ckpt_path, output_vae=True, output_clip=True, 
...
class CR_CycleLoRAs:
    ...
    def cycle(self, mode, model, clip, lora_list, frame_interval, loops, current_frame):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Cycler-Nodes#cr-cycle-loras"
        ...
        if mode == "Sequential":
            ...
            model_lora, clip_lora = quasar.sd.load_lora_for_models(
...
class CR_CycleText:
    ...
    def cycle_text(self, mode, text_list, frame_interval, loops, current_frame,):
        ...
        if mode == "Sequential":
            ...
            show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Cycler-Nodes#cr-cycle-text"
...
class CR_CycleTextSimple:
    ...
    def cycle_text(self, mode, frame_interval, loops, current_frame,
        ...
        if mode == "Sequential":
            ...
            show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Cycler-Nodes#cr-cycle-text-simple"
...
class CR_CycleImages:
    ...
    def cycle(self, mode, image_list, frame_interval, loops, current_frame,):
        ...
        if mode == "Sequential":
            ...
            show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Cycler-Nodes#cr-cycle-images"
...
class CR_CycleImagesSimple:
    ...
    def cycle_image(self, mode, frame_interval, loops, current_frame,
        ...
        if mode == "Sequential":
            ...
            show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Cycler-Nodes#cr-cycle-images-simple"
            return (current_image_item, show_help, )
