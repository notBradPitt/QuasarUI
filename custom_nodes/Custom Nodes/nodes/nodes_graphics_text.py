...
class CR_OverlayText:
    ...
    CATEGORY = icons.get("Quasarroll/Graphics/Text")
    ...
    def overlay_text(self, image, text, font_name, font_size, font_color,  
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Text-Nodes#cr-overlay-text"
...
class CR_DrawText:
    ...
    def draw_text(self, image_width, image_height, text,
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Text-Nodes#cr-draw-text"
...
class CR_MaskText:
    ...
    def mask_text(self, image, text, font_name, font_size,
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Text-Nodes#cr-mask-text"
...
class CR_CompositeText:
    ...
    def composite_text(self, image_text, image_background, text,
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Text-Nodes#cr-composite-text"
...
class CR_ArabicTextRTL:
    ...
    def adjust_arabic_to_rtl(self, arabic_text):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Text-Nodes#cr-arabic-text-rtl"
...
class CR_SimpleTextWatermark:
    ...
    def overlay_text(self, image, text, align,
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Text-Nodes#cr-simple-text-watermark"
...
class CR_SelectFont:
    ...
    def select_font(self, font_name):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Text-Nodes#cr-select-font"    
