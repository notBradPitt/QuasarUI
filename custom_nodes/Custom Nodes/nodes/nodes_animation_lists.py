...
class CR_TextList:
    ...
    FUNCTION = "text_list"
    CATEGORY = icons.get("Quasarroll/Animation/List")
...
class CR_TextListSimple:
    ...
    def text_list_simple(self, text_1, text_2, text_3,  text_4, text_5, text_list_simple=None):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/List-Nodes#cr-text-list-simple"
...
class CR_ImageListSimple:
    ...
    def image_list_simple(self,
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/List-Nodes#cr-image-list-simple"         
...
class CR_InputTextList:
    ...
    def text_list_simple(self, text):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Animation-Utility-Nodes#cr-input-text-list"
