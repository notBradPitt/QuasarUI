...
class CR_LoadAnimationFrames:
    ...
    CATEGORY = icons.get("Quasarroll/Animation/IO")
    ...
    def load_image_sequence(self, image_sequence_folder, start_index, max_frames):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/IO-Nodes#cr-load-animation-frames"                        
...
# based on Load Image Sequence in vid2vid and mtb
    ...
    def load_images(self, file_pattern, skip_start_frames, input_folder, sort_by, current_frame, input_path=''):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/IO-Nodes#cr-load-flow-frames"
        ...
        print(f"[Info] CR Load Flow Frames: QuasarUI Input directory is `{image_path}`")
