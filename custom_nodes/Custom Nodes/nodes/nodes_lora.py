...
class CR_LoraLoader:
    ...
    FUNCTION = "load_lora"
    CATEGORY = icons.get("Quasarroll/LoRA")

    def load_lora(self, model, clip, switch, lora_name, strength_model, strength_clip):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/LoRA-Nodes#cr-load-lora"
...
class CR_LoRAStack:
    ...
    def lora_stacker(self, lora_name_1, model_weight_1, clip_weight_1, switch_1, lora_name_2, model_weight_2, clip_weight_2, switch_2, lora_name_3, model_weight_3, clip_weight_3, switch_3, lora_stack=None):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/LoRA-Nodes#cr-lora-stack"           
...
class CR_ApplyLoRAStack:
    ...
    def apply_lora_stack(self, model, clip, lora_stack=None,):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/LoRA-Nodes#cr-apply-lora-stack"
