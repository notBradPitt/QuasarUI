...
class CR_SplitString:
    ...
    FUNCTION = "split"
    CATEGORY = icons.get("Quasarroll/Utils/Text")
    ...
    def split(self, text, delimiter=""):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Other-Nodes#cr-split-string"
...
class CR_Text:
    ...
    def text_multiline(self, text):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Other-Nodes#cr-text"
...
class CR_MultilineText:
    ...
    def text_multiline(self, text, chars_to_remove, split_string=False, remove_chars=False, convert_from_csv=False, csv_quote_char="'"):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Other-Nodes#cr-multiline-text"
...
class CR_SaveTextToFile:
    ...
    def save_list(self, multiline_text, output_file_path, file_name, file_extension):
        ...
        show_help =  "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/List-Nodes#cr-save-text-to-file" 
...
class CR_TextReplace:
    ...
    def replace_text(self, text, find1="", replace1="", find2="", replace2="", find3="", replace3=""):
        ...
        show_help =  "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/List-Nodes#cr-text-replace" 
...
class CR_TextBlacklist:
    ...
    def replace_text(self, text, blacklist_words, replacement_text=""):
        ...
        show_help =  "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/List-Nodes#cr-text-blacklist" 
...
class CR_TextOperation:
    ...
    def text_operation(self, text, operation):
        ...
        show_help =  "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/List-Nodes#cr-text_operation" 
...
class CR_TextLength:
    ...
    def len_text(self, text):
        ...
        show_help =  "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/List-Nodes#cr-text-length" 
