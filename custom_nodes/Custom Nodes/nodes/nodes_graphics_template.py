...
class CR_SimpleMemeTemplate:
    ...
    def INPUT_TYPES(s):
        ...
        simple_meme_presets = ["custom",
                               "One Does Not Simply ... MEME IN QUASAR",
                               "This is fine.",
    ...
    FUNCTION = "make_meme"
    CATEGORY = icons.get("Quasarroll/Graphics/Template")
    ...
    def make_meme(self, image, preset,
        ...
        for img in image:
            ...
            if preset == "One Does Not Simply ... MEME IN QUASAR":
                text_top = "One Does Not Simply"
                text_bottom = "MEME IN QUASAR"
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Template-Nodes#cr-simple-meme-template"
...
class CR_SimpleBanner:
    ...
    def make_banner(self, image, banner_text,
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Template-Nodes#cr-simple-banner"
...
class CR_ComicPanelTemplates:
    ...
    def layout(self, page_width, page_height, template, reading_direction,
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Template-Nodes#cr-comic-panel-templates"
...
class CR_SimpleImageCompare:
    ...
    def layout(self, text1, text2,
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Layout-Nodes#cr-simple-image-compare"
...
class CR_ThumbnailPreview:
    ...
    def thumbnail(self, image, rescale_factor, max_columns):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Template-Nodes#cr-thumbnail-preview"
...
class CR_SeamlessChecker:
    ...
    def thumbnail(self, image, rescale_factor, grid_options):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Other-Nodes#cr-seamless-checker"
