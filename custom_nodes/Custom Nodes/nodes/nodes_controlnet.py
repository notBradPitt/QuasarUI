...
class CR_ApplyControlNet:
    ...
    CATEGORY = icons.get("Quasarroll/ControlNet")

    def apply_controlnet(self, conditioning, control_net, image, switch, strength):
        
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/ControlNet-Nodes#cr-apply-controlnet"
...
class CR_ControlNetStack:
    ...
    def controlnet_stacker(self, switch_1, controlnet_1, controlnet_strength_1, start_percent_1, end_percent_1,
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/ControlNet-Nodes#cr-multi-controlnet-stack"
...
class CR_ApplyControlNetStack:
    ...
    def apply_controlnet_stack(self, base_positive, base_negative, switch, controlnet_stack=None,):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/ControlNet-Nodes#cr-apply-multi-controlnet-stack"
