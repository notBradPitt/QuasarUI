...
class CR_GradientInteger:
    ...
    FUNCTION = "gradient"
    CATEGORY = icons.get("Quasarroll/Animation/Interpolate")

    def gradient(self, start_value, end_value, start_frame, frame_duration, current_frame, gradient_profile):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Interpolation-Nodes#cr-gradient-integer"
...
class CR_GradientFloat:
    ...
    def gradient(self, start_value, end_value, start_frame, frame_duration, current_frame, gradient_profile):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Interpolation-Nodes#cr-gradient-float"
...
class CR_IncrementFloat:
    ...
    def increment(self, start_value, step, start_frame, frame_duration, current_frame):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Interpolation-Nodes#cr-increment-float"
...
class CR_IncrementInteger:
    ...
    def increment(self, start_value, step, start_frame, frame_duration, current_frame):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Interpolation-Nodes#cr-increment-integer"
...
class CR_InterpolateLatents:
    ...
    def interpolate(self, latent1, latent2, weight, method):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Interpolation-Nodes#cr-interpolate-latents"
