...
class CR_ValueScheduler:
    ...
    FUNCTION = "schedule"
    CATEGORY = icons.get("Quasarroll/Animation/Schedulers")

    def schedule(self, mode, current_frame, schedule_alias, default_value, schedule_format, schedule=None):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Scheduler-Nodes#cr-value-scheduler"
...
class CR_TextScheduler:
    ...
    def schedule(self, mode, current_frame, schedule_alias, default_text, schedule_format, schedule=None):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Scheduler-Nodes#cr-text-scheduler"
...
class CR_PromptScheduler:
    ...
    def schedule(self, mode, prepend_text, append_text, current_frame, schedule_alias, default_prompt, schedule_format, interpolate_prompt, keyframe_list="", schedule=None):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Scheduler-Nodes#cr-prompt-scheduler"
...
class CR_SimplePromptScheduler:
    ...
    def simple_schedule(self, keyframe_list, keyframe_format, current_frame):
        ...
        if current_prompt == "":
            ...
            show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Scheduler-Nodes#cr-simple-prompt-scheduler"
...
class CR_SimpleValueScheduler:
    ...
    def simple_schedule(self, schedule, current_frame):
        ...
        if params == "":
            ...
            show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Scheduler-Nodes#cr-simple-value-scheduler"
...
class CR_SimpleTextScheduler:
    ...
    def simple_schedule(self, schedule, current_frame):
        ...
        if params == "":
            ...
            show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Scheduler-Nodes#cr-simple-text-scheduler"
...
class CR_LoadScheduledModels:
    ...
    def schedule(self, mode, current_frame, schedule_alias, default_model, schedule_format, model_list=None, schedule=None):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Scheduler-Nodes#cr-load-scheduled-models"
...
class CR_LoadScheduledLoRAs:
    ...
    def schedule(self, mode, model, clip, current_frame, schedule_alias, default_lora, strength_model, strength_clip, schedule_format, lora_list=None, schedule=None):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Scheduler-Nodes#cr-load-scheduled-loras"
        #lora_name = ""
