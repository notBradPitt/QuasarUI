...
class CR_RandomHexColor:
    ...
    FUNCTION = "get_colors"
    CATEGORY = icons.get("Quasarroll/Utils/Random")
    ...
    def get_colors(self, seed):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Other-Nodes#cr-random-hex-color"
...
class CR_RandomRGB:
    ...
    def get_colors(self, seed):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Other-Nodes#cr-random-rgb"
...
class CR_RandomMultilineValues:
    ...
    def generate(self, value_type, rows, string_length, custom_values, seed, prepend_text):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Other-Nodes#cr-random-multiline-values"
...
class CR_RandomMultilineColors:
    ...
    def generate(self, value_type, rows, seed):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Other-Nodes#cr-random-multiline-colors"
...
class CR_RandomPanelCodes:
    ...
    def generate(self, rows, string_length, values, seed):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Other-Nodes#cr-random-panel-codes"
...
class CR_RandomRGBGradient:
    ...
    def generate(self, rows, seed):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Other-Nodes#cr-random-RGB-gradient"
