...
class CR_DataBusIn:
    ...
    FUNCTION = "load_data"
    CATEGORY = icons.get("Quasarroll/Pipe/Bus")

    def load_data(self, any1=None, any2=None, any3=None, any4=None, pipe=None):
 
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Pipe-Nodes#cr-data-bus-in"
...
class CR_DataBusOut:
    ...
    def data_out(self, any1=None, any2=None, any3=None, any4=None, pipe=None):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Pipe-Nodes#cr-data-bus-out"
...
class CR_8ChannelIn:
    ...
    def load_data(self, ch1=None, ch2=None, ch3=None, ch4=None, ch5=None, ch6=None, ch7=None, ch8=None, pipe=None):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Pipe-Nodes#cr-8-channel-in"
...
class CR_8ChannelOut:
    ...
    def data_out(self, ch1=None, ch2=None, ch3=None, ch4=None, ch5=None, ch6=None, ch7=None, ch8=None, pipe=None):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Pipe-Nodes#cr-8-channel-out"
...
class CR_ModulePipeLoader:
    ...
    RETURN_NAMES = ("pipe", "show_help", )
    FUNCTION = "pipe_input"
    CATEGORY = icons.get("Quasarroll/Pipe/Module")

    def pipe_input(self, model=0, pos=0, neg=0, latent=0, vae=0, clip=0, controlnet=0, image=0, seed=0):
        
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Pipe-Nodes#cr-module-pipe-loader"   
...
class CR_ModuleInput:
    ...
    def flush(self, pipe):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Pipe-Nodes#cr-module-input"
...
class CR_ModuleOutput:
    ...
    def pipe_output(self, pipe, model=None, pos=None, neg=None, latent=None, vae=None, clip=None, controlnet=None, image=None, seed=None):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Pipe-Nodes#cr-module-output"   
...
class CR_ImagePipeIn:
    ...
    RETURN_NAMES = ("pipe", "show_help", )
    FUNCTION = "pipe_in"
    CATEGORY = icons.get("Quasarroll/Pipe/Image")

    def pipe_in(self, image=0, width=0, height=0, upscale_factor=0):
        
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Pipe-Nodes#cr-image-pipe-in"
...
class CR_ImagePipeEdit:
    ...
    def pipe_edit(self, pipe, image=None, width=None, height=None, upscale_factor=None):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Pipe-Nodes#cr-image-pipe-edit"
...
class CR_ImagePipeOut:
    ...
    def pipe_out(self, pipe):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Pipe-Nodes#cr-image-pipe-out"
...
class CR_InputSwitchPipe:
    ...
    CATEGORY = icons.get("Quasarroll/Pipe")

    def switch_pipe(self, Input, pipe1, pipe2):
    
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Pipe-Nodes#cr-pipe-switch"
