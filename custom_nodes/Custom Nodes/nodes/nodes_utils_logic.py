...
class CR_ImageInputSwitch:
    ...
    FUNCTION = "switch"
    CATEGORY = icons.get("Quasarroll/Utils/Logic")

    def switch(self, Input, image1=None, image2=None):
    
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Logic-Nodes#cr-image-input-switch"
...
class CR_LatentInputSwitch:
    ...
    def switch(self, Input, latent1=None, latent2=None):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Logic-Nodes#cr-latent-input-switch"
        if Input == 1:
...
class CR_ConditioningInputSwitch:
    ...
    def switch(self, Input, conditioning1=None, conditioning2=None):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Logic-Nodes#cr-conditioning-input-switch"
        if Input == 1:
...
class CR_ClipInputSwitch:
    ...
    def switch(self, Input, clip1=None, clip2=None):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Logic-Nodes#cr-clip-input-switch"
        if Input == 1:
...
class CR_ModelInputSwitch:
    ...
    def switch(self, Input, model1=None, model2=None):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Logic-Nodes#cr-model-input-switch"
        if Input == 1:
...
class CR_ControlNetInputSwitch:
    ...
    def switch(self, Input, control_net1=None, control_net2=None):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Logic-Nodes#cr-controlnet-input-switch"
        if Input == 1:
...
class CR_TextInputSwitch:
    ...
    def switch(self, Input, text1=None, text2=None,):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Logic-Nodes#cr-text-input-switch"
        if Input == 1:
...
class CR_VAEInputSwitch:
    ...
    def switch(self, Input, VAE1=None, VAE2=None,):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Logic-Nodes#cr-vae-input-switch"
        if Input == 1:
...
class CR_ImageInputSwitch4way:
    ...
    def switch(self, Input, image1=None, image2=None, image3=None, image4=None):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Logic-Nodes#cr-text-input-switch-4-way"
        if Input == 1:
            return (image1, show_help, )
        elif Input == 2:
            return (image2, show_help, )
...
class CR_ModelAndCLIPInputSwitch:
    ...
    def switch(self, Input, clip1, clip2, model1, model2):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Logic-Nodes#cr-switch-model-and-clip"
        if Input == 1:
...
class CR_Img2ImgProcessSwitch:
    ...
    RETURN_NAMES = ("LATENT", "show_help", )
    FUNCTION = "switch"
    CATEGORY = icons.get("Quasarroll/Utils/Process")

    def switch(self, Input, txt2img=None, img2img=None):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Process-Nodes#cr-img2img-process-switch"
        if Input == "txt2img":
...
class CR_HiResFixProcessSwitch:
    ...
    def switch(self, Input, latent_upscale=None, image_upscale=None):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Process-Nodes#cr-hires-fix-process-switch"
...
class CR_BatchProcessSwitch:
    ...
    def switch(self, Input, image=None, image_batch=None):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Process-Nodes#cr-batch-process-switch"
        if Input == "image":
