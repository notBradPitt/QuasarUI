...
class CR_ImageOutput:
    ...
    OUTPUT_NODE = True
    CATEGORY = icons.get("Quasarroll/Essential/Core")
    ...
    def save_images(self, images, file_format, prefix_presets, filename_prefix="CR",
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Core-Nodes#cr-image-output"
...
class CR_Seed:
    ...
    @staticmethod
    def seedint(seed):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Core-Nodes#cr-seed"
...
class CR_LatentBatchSize:
    ...
    def batchsize(self, latent: tg.Sequence[tg.Mapping[tg.Text, torch.Tensor]], batch_size: int):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Core-Nodes#cr-latent-batch-size"
...
class CR_PromptText:
    ...
    def get_value(self, prompt):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Core-Nodes#cr-prompt-text"
...
class CR_CombinePrompt:
    ...
    def get_value(self, part1="", part2="", part3="", part4="", separator=""):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Core-Nodes#cr-prompt-parts"
...
class CR_ConditioningMixer:
    ...
    def conditioning(self, mix_method, conditioning_1, conditioning_2, average_strength):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Core-Nodes#cr-conditioning-mixer"
...
class CR_SelectModel:
    ...
    def select_model(self, ckpt_name1, ckpt_name2, ckpt_name3, ckpt_name4, ckpt_name5, select_model):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Core-Nodes#cr-select-model"
        ...
        model, clip, vae, clipvision = quasar.sd.load_checkpoint_guess_config(ckpt_path, output_vae=True, output_clip=True,
...
class CR_VAEDecode:
    ...
    def vae_decode(self, samples, vae, circular=False, tiled=False):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Core-Nodes#cr-vae-decode"    
