...
class CR_SimplePromptList:
    ...
    CATEGORY = icons.get("Quasarroll/Animation/Legacy")
    ...
    def prompt_stacker(self, prompt_1, prompt_2, prompt_3, prompt_4, prompt_5, simple_prompt_list=None):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Prompt-Nodes#cr-simple-prompt-list"           
...
class CR_SimplePromptListKeyframes:
    ...
    def make_keyframes(self, simple_prompt_list, keyframe_interval, loops, transition_type, transition_speed, transition_profile, keyframe_format, ):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Prompt-Nodes#cr-simple-prompt-list-keyframes"
...
class CR_PromptList:
    ...
    def animation_stacker(self, keyframe_interval, loops, 
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Prompt-Nodes#cr-prompt-list"
...
class CR_PromptListKeyframes:
    ...
    def make_keyframes(self, prompt_list, keyframe_format):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Prompt-Nodes#cr-prompt-list-keyframes"
...
class CR_KeyframeList:
    ...
    CATEGORY = icons.get("Quasarroll/Animation/Prompt")

    def keyframelist(self, keyframe_list, keyframe_format):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Prompt-Nodes#cr-keyframe-list"          
        return (keyframe_list, show_help, )
...
class CR_LoadPromptStyle:
    ...
    def prompt_styler(self, style, file_type):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Prompt-Nodes#cr-load-prompt-style"
...
class CR_EncodeScheduledPrompts:
    ...
    def condition(self, clip, current_prompt, next_prompt, weight):      
        ...
        for i in range(len(conditioning_to)):
            ...
            n = [tw, t_to]
            out.append(n)
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Prompt-Nodes#cr-encode-scheduled-prompts"
