...
class CR_ColorTint:
    ...
    FUNCTION = "color_tint"
    CATEGORY = icons.get("Quasarroll/Graphics/Filter")
    ...
    def color_tint(self, image: torch.Tensor, strength, mode: str="sepia", tint_color_hex='#000000'):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Filter-Nodes#cr-color-tint"
...
class CR_HalftoneFilter:
    ...
    def _halftone_pil(self, im, cmyk, sample, scale, angles, antialias, border_blending, antialias_scale, shape):
        ...
        for channel_index, (channel, angle) in enumerate(zip(cmyk, angles)):
            ...
            show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Filter-Nodes#cr-halftone-filter"
...
class CR_VignetteFilter:
    ...
    def make_vignette(self, image, feather_amount, reverse,
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Layout-Nodes#cr-vignette-filter"
