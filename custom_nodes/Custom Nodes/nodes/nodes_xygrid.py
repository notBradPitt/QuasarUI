...
#---------------------------------------------------------------------------------------------------------------------#
# based on https://github.com/LEv145/images-grid-quasar-plugin
...
class CR_XYList:
    ...
    FUNCTION = "cross_join"
    CATEGORY = icons.get("Quasarroll/XY Grid") 
    ...
    y_prepend, y_append, y_annotation_prepend, index):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/XY-Grid-Nodes#cr-xy-list"
...
class CR_XYInterpolate:
    ...
    index, gradient_profile):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/XY-Grid-Nodes#cr-xy-interpolate"
...
class CR_XYIndex: 
    ...
    def index(self, x_columns, y_rows, index):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/XY-Grid-Nodes#cr-xy-index"
...
class CR_XYFromFolder:
    ...
    def load_images(self, image_folder, start_index, end_index, max_columns, x_annotation, y_annotation, font_size, gap, trigger=False):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/XY-Grid-Nodes#cr-xy-from-folder"
