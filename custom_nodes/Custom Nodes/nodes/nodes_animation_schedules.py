...
class CR_SimpleSchedule:
    ...
    CATEGORY = icons.get("Quasarroll/Animation/Schedule")
    ...
    def send_schedule(self, schedule, schedule_type, schedule_alias, schedule_format):
      ...
      # Extend the list for each line in the schedule
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Schedule-Nodes#cr-simple-schedule"
...
#---------------------------------------------------------------------------------------------------------------------#
class Quasarroll_ScheduleInputSwitch:
    def __init__(self):
        pass
    ...
    def switch(self, Input, schedule1, schedule2):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Schedule-Nodes#cr-schedule-input-switch"
        if Input == 1:
...
class CR_LoadScheduleFromFile:
    ...
    def csvinput(self, input_file_path, file_name, file_extension):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Schedule-Nodes#cr-load-schedule-from-file"
...
class CR_BitSchedule:
    ...
    def bit_schedule(self, binary_string, interval, loops=1):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Schedule-Nodes#cr-bit-schedule"
