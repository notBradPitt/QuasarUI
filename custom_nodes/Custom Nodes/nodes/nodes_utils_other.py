...
class CR_ClampValue:
    ...
    def clamp_value(self, a, range_min, range_max):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Other-Nodes#cr-clamp-value"
...
class CR_IntegerMultipleOf:
    ...
    def int_multiple_of(self, integer, multiple=8):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Other-Nodes#cr-integer-multiple"
...
class CR_Value:
    ...
    def get_value(self, value):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Other-Nodes#cr-value"
...
class CR_MathOperation:
    ...
    def do_math(self, a, operation, decimal_places):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Other-Nodes#cr-math-operation"    
...
class CR_GetParameterFromPrompt:
    ...
    def get_string(self, prompt, search_string):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Other-Nodes#cr-find-string-in-prompt"    
...
class CR_SelectResizeMethod:
    ...
    def set_switch(self, method):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Other-Nodes#cr-select-resize-method"    
...
class CR_SetValueOnBinary:
    ...
    FUNCTION = "set_value"    
    CATEGORY = icons.get("Quasarroll/Utils/Conditional")
    
    def set_value(self, binary, value_if_1, value_if_0):

        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Other-Nodes#cr-set-value-on-boolean"
...
class CR_SetValueOnString:
    ...
    def replace_text(self, text, test_string, value_if_true, value_if_false):
        ...
        show_help =  "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/List-Nodes#cr-set-value-on-string" 
...
class CR_SetSwitchFromString:
    ...
    def set_switch(self, text, switch_1="", switch_2="", switch_3="", switch_4=""):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Other-Nodes#cr-set-switch-from-string"    
