#---------------------------------------------------------------------------------------------------------------------#
# Quasarroll Studio custom nodes by RockOfFire and Akatsuzi    https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes                             
...
class CR_TextList:
    ...
    FUNCTION = "make_list"
    CATEGORY = icons.get("Quasarroll/List")

    def make_list(self, multiline_text, start_index, max_rows, loops):

        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Other-Nodes#cr-text-list"
...
class CR_PromptList:
    ...
    def make_list(self, multiline_text, prepend_text="", append_text="", start_index=0, max_rows=9999):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/List-Nodes#cr-prompt-list"
...
class CR_LoadImageList:
    ...
    OUTPUT_IS_LIST = (True, False)
    FUNCTION = "make_list"
    CATEGORY = icons.get("Quasarroll/List/IO")

    def make_list(self, start_index, max_images, input_folder, input_path=None):

        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/List-Nodes#cr-image-list"
...
class CR_LoadImageListPlus:
    ...
    def make_list(self, start_index, max_images, input_folder, input_path=None, vae=None):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/List-Nodes#cr-image-list-plus"
...
class CR_LoadGIFAsList:
    ...
    def load_gif(self, input_folder, gif_filename, start_frame, max_frames, input_path=None):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/List-Nodes#cr-load-gif-images"
...
class CR_FontFileList:
    ...
    def INPUT_TYPES(s):
        ...
        quasarroll_font_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.realpath(__file__))), "fonts")       
        quasarroll_file_list = [f for f in os.listdir(quasarroll_font_dir) if os.path.isfile(os.path.join(quasarroll_font_dir, f)) and f.lower().endswith(".ttf")]

        sources = ["system", "Quasarroll", "from folder"]
    ...
    def make_list(self, source_folder, start_index, max_rows, folder_path="C:\Windows\Fonts"):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/List-Nodes#cr-font-file-list"
        ...
        elif source_folder == "Quasarroll":
            quasarroll_font_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.realpath(__file__))), "fonts")       
            file_list = [f for f in os.listdir(quasarroll_font_dir) if os.path.isfile(os.path.join(quasarroll_font_dir, f)) and f.lower().endswith(".ttf")]
...
class CR_FloatRangeList:
    ...
    def make_range(self, start, end, step, max_values_per_loop, operation, decimal_places, ignore_first_value, loops, ping_pong):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/List-Nodes#cr-float-range-list"      
...
class CR_IntegerRangeList:
    ...
    def make_range(self, start, end, step, loops, ping_pong):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/List-Nodes#cr-list-schedule"      
...
class CR_LoadTextList:
    ...
    def load_list(self, input_file_path, file_name, file_extension):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/List-Nodes#cr-load-value-list"      
...
class CR_IntertwineLists:
    ...
    OUTPUT_IS_LIST = (True, False)      
    FUNCTION = 'make_list'
    CATEGORY = icons.get("Quasarroll/List/Utils")

    def make_list(self, list1, list2):
           
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/List-Nodes#cr-intertwine-lists"      
...
class CR_BinaryToBitList:
    ...
    def make_list(self, bit_string):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/List-Nodes#cr-binary-to-list" 
...
class CR_TextListToString:
    ...
    def joinlist(self, text_list):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/List-Nodes#cr-text-list-to-string"
...
class CR_SimpleList:
    ...
    def cross_join(self, list_values):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/List-Nodes#cr-simple-list"
...
class CR_XYProduct:
    ...
    def cross_join(self, text_x, text_y):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/List-Nodes#cr-xy-product"
...
class CR_Repeater:
    ...
    def repeat_list_items(self, input_data, repeats):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/List-Nodes#cr-repeater"
...
class CR_TextCycler:
    ...
    def cycle(self, text, repeats, loops=1):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/List-Nodes#cr-text-cycler"
...
class CR_ValueCycler:
    ...
    def cycle(self, values, repeats, loops=1):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/List-Nodes#cr-value-cycler"
