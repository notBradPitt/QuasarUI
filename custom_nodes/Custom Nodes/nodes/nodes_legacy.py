...
class CR_ImageSize:
    ...
    FUNCTION = "ImageSize"
    CATEGORY = icons.get("Quasarroll/Essential/Legacy")

    def ImageSize(self, width, height, upscale_factor):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Legacy-Nodes#cr-image-size"
...
class CR_AspectRatio_SDXL:
    ...
    def Aspect_Ratio(self, width, height, aspect_ratio, swap_dimensions, upscale_factor1, upscale_factor2, batch_size):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Legacy-Nodes#cr-aspect-ratio-sdxl"
...
class CR_PromptMixer:
    ...
    def mixer(self, prompt_positive, prompt_negative, style_positive, style_negative, preset):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Legacy-Nodes#cr-prompt-mixer"
...
class CR_SeedToInt:
    ...
    def seed_to_int(self, seed):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Conversion-Nodes#cr-seed-to-int"
