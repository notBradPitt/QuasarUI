...
class CR_Trigger: 
    ...
    FUNCTION = "trigger"
    CATEGORY = icons.get("Quasarroll/Utils/Index")

    def trigger(self, index, trigger_value):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Index-Nodes#cr-trigger"
...
class CR_Index: 
    ...
    def index(self, index, print_to_console):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Index-Nodes#cr-index"
...
class CR_IncrementIndex:
    ...
    def increment(self, index, interval):
        index+=interval
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Index-Nodes#cr-index-increment"
        return (index, show_help, )
...
class CR_MultiplyIndex:
    ...
    def multiply(self, index, factor):
        index = index * factor
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Index-Nodes#cr-index-multiply"
...
class CR_IndexReset:
    ...
    def reset(self, index, reset_to):
        index = reset_to
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Index-Nodes#cr-index-reset"
