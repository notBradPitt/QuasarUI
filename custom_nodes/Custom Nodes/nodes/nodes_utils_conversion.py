...
class CR_StringToNumber: 
    ...
    FUNCTION = "convert"
    CATEGORY = icons.get("Quasarroll/Utils/Conversion")
    ...
    def convert(self, text, round_integer):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Conversion-Nodes#cr-string-to-number"
...
class CR_StringToCombo:
    ...
    def convert(self, text):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Conversion-Nodes#cr-string-to-combo"
...
class CR_StringToBoolean:
    ...
    def convert(self, text):
        ...
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Conversion-Nodes#cr-string-to-boolean"
...
class CR_IntegerToString:
    ...
    def convert(self, int_):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Conversion-Nodes#cr-integer-to-string"
...
class CR_FloatToString:
    ...
    def convert(self, float_):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Conversion-Nodes#cr-float-to-string"
...
class CR_FloatToInteger:
    ...
    def convert(self, _float):
        show_help = "https://github.com/Suzie1/QuasarUI_Quasarroll_CustomNodes/wiki/Conversion-Nodes#cr-float-to-integer"
