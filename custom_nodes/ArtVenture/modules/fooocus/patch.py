...
import quasar.ldm.modules.diffusionmodules.openaimodel
import quasar.samplers

from quasar.samplers import model_management, math
from quasar.ldm.modules.diffusionmodules.openaimodel import (
    timestep_embedding,
...
original_sampling_function = quasar.samplers.sampling_function
original_unet_forward = quasar.ldm.modules.diffusionmodules.openaimodel.UNetModel.forward
original_sdxl_encode_adm = quasar.model_base.SDXL.encode_adm
...
def patch_all():
    quasar.samplers.sampling_function = sampling_function_patched
    quasar.model_base.SDXL.encode_adm = sdxl_encode_adm_patched
    quasar.ldm.modules.diffusionmodules.openaimodel.UNetModel.forward = unet_forward_patched


def unpatch_all():
    quasar.samplers.sampling_function = original_sampling_function
    quasar.model_base.SDXL.encode_adm = original_sdxl_encode_adm
    quasar.ldm.modules.diffusionmodules.openaimodel.UNetModel.forward = original_unet_forward
