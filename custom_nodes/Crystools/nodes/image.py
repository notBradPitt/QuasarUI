...
# subfolders based on: https://github.com/catscandrive/quasarui-imagesubfolders
...
class CImageSaveWithExtraMetadata(SaveImage):
    ...
    def execute(self, image=None, filename_prefix="QuasarUI", with_workflow=True, metadata_extra=None, prompt=None, extra_pnginfo=None):
        data = {
            "result": [''],
            "ui": {
                "text": [''],
