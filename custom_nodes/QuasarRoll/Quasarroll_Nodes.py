#---------------------------------------------------------------------------------------------------------------------------------------------------#
# Quasarroll Custom Nodes by RockOfFire and Akatsuzi         https://github.com/RockOfFire/QuasarUI_Quasarroll_CustomNodes                             #
# for QuasarUI                                               https://github.com/quasaranonymous/QuasarUI                                               #
#---------------------------------------------------------------------------------------------------------------------------------------------------#
...
class Quasarroll_ImageInputSwitch:
    def __init__(self):
        pass
...
class Quasarroll_ImageInputSwitch_4way:
    def __init__(self):
        pass
...
class Quasarroll_LatentInputSwitch:
    def __init__(self):
        pass
...
class Quasarroll_ConditioningInputSwitch:
    def __init__(self):
        pass
...
class Quasarroll_ClipInputSwitch:
    def __init__(self):
        pass
...
class Quasarroll_ModelInputSwitch:
    def __init__(self):
        pass
...
class Quasarroll_ControlNetInputSwitch:
    def __init__(self):
        pass
...
class Quasarroll_TextInputSwitch:
    def __init__(self):
        pass
...
class Quasarroll_TextInputSwitch_4way:
    def __init__(self):
        pass
...
class Quasarroll_InputLatentsText:
    def __init__(self):
        pass
...
class Quasarroll_HiResFixSwitch:
    def __init__(self):
        pass
...
class Quasarroll_BatchProcessSwitch:
    def __init__(self):
        pass
...
#This node has a bunch of default picture widths and heights as well as being able to choose them yourself.
class Quasarroll_AspectRatio_v2:
    def __init__(self):
        pass
...
class Quasarroll_ImageSize_Float:
    def __init__(self):
        pass
...
class Quasarroll_ImageOutput:
    ...
    def save_images(self, images, filename_prefix="QuasarUI", output_type = "Preview", prompt=None, extra_pnginfo=None):
...
class Quasarroll_Int_Multiple_Of:
    def __init__(self):
        pass
...
class Quasarroll_Halftone_Grid:
    @classmethod
    def INPUT_TYPES(s):
        return {"required": {
                    "width": ("INT", {"default": 512, "min": 64, "max": 2048}),
...
class Quasarroll_LatentBatchSize:
...
class Quasarroll_ApplyLoRA_Stack:
    ...
    def apply_lora_stack(self, model, clip, lora_stack=None,):
        ...
        for tup in lora_params:
            ...
            model_lora, clip_lora = quasar.sd.load_lora_for_models(model_lora, clip_lora, lora, strength_model, strength_clip)  
...
class Quasarroll_ApplyControlNet:
    @classmethod
    def INPUT_TYPES(s):
    ...
    CATEGORY = "Quasarroll/Conditioning"
...
class Quasarroll_ControlNetStack:
    ...
    def controlnet_stacker(self, switch_1, controlnet_1, controlnet_strength_1, start_percent_1, end_percent_1,
        ...
        if controlnet_1 != "None" and  switch_1 == "On" and image_1 is not None:
            ...
            controlnet_1 = quasar.controlnet.load_controlnet(controlnet_path)
        ...
        if controlnet_2 != "None" and  switch_2 == "On" and image_2 is not None:
            ...
            controlnet_2 = quasar.controlnet.load_controlnet(controlnet_path)
        ...
        if controlnet_3 != "None" and  switch_3 == "On" and image_3 is not None:
            ...
            controlnet_3 = quasar.controlnet.load_controlnet(controlnet_path)
...
class Quasarroll_ApplyControlNetStack:
    @classmethod
    def INPUT_TYPES(s):
        ...
        if controlnet_stack is not None:
            for controlnet_tuple in controlnet_stack:
                ...
                if type(controlnet_name) == str:
                    ...
                    controlnet = quasar.sd.load_controlnet(controlnet_path)
                else:
...
class Quasarroll_ModelMergeStack:
    ...
    CATEGORY = "Quasarroll/Model Merge"
...
class Quasarroll_ApplyModelMerge:
    ...
    def merge(self, model_stack, merge_method, normalise_ratios, weight_factor):
        ...
        if len(model_stack) == 1:
            ...
            return quasar.sd.load_checkpoint_guess_config(ckpt_path, output_vae=True, output_clip=True, embedding_directory=folder_paths.get_folder_paths("embeddings"))
        ...
        for i, model_tuple in enumerate(model_stack):
            model_name, model_ratio, clip_ratio = model_tuple
            ckpt_path = folder_paths.get_full_path("checkpoints", model_name)
            merge_model = quasar.sd.load_checkpoint_guess_config(ckpt_path, output_vae=True, output_clip=True, embedding_directory=folder_paths.get_folder_paths("embeddings"))
            ...
            if i == 0: 
                ...
                # Merge next model
                # Quasar merge logic is flipped for stacked nodes. This is because the first model is effectively model1 and all subsequent models are model2. 
...
class Quasarroll_ModelAndCLIPInputSwitch:
    def __init__(self):
        pass
...
'''
NODE_CLASS_MAPPINGS = {
    "CR Image Input Switch": Quasarroll_InputImages,
    "CR Image Input Switch (4 way)": Quasarroll_InputImages_4way,
    "CR Latent Input Switch": Quasarroll_InputLatents,
    "CR Process Switch": Quasarroll_InputLatentsText,
    "CR Conditioning Input Switch": Quasarroll_InputConditioning,
    "CR Clip Input Switch": Quasarroll_InputClip,
    "CR Model Input Switch": Quasarroll_InputModel,
    "CR ControlNet Input Switch": Quasarroll_InputControlNet,
    ...
    "CR Halftones" :Quasarroll_Halftone_Grid,
...
#---------------------------------------------------------------------------------------------------------------------------------------------------#
# Credits                                                                                                                                           #
# WASasquatch                             https://github.com/WASasquatch/was-node-suite-quasarui                                                     #
# hnmr293				                  https://github.com/hnmr293/QuasarUI-nodes-hnmr      		                                                #
# SeargeDP                                https://github.com/SeargeDP/SeargeSDXL                                                                    #
# LucianoCirino                           https://github.com/LucianoCirino/efficiency-nodes-quasarui                                                 #
# credit SLAPaper                         https://github.com/SLAPaper/QuasarUI-Image-Selector                                                        #
