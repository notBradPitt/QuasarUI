...
class Quasarroll_prompt_mixer_v2:
    def __init__(self):
        pass
...
class Quasarroll_SDXLStyleText:
    @classmethod
    def INPUT_TYPES(s):
        return {"required": {
...
class Quasarroll_SDXLBasePromptEncoder:
    @classmethod
    def INPUT_TYPES(s):
        return {"required": {
                    "base_clip": ("CLIP", ),
...
class Quasarroll_AspectRatio_SDXL:
    def __init__(self):
        pass
...
class Quasarroll_SDXL_AspectRatio_v2:
    def __init__(self):
        pass
