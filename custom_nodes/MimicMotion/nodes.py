...
class DownloadAndLoadMimicMotionModel:
    ...
    def loadmodel(self, precision, model):
        ...
        pbar = quasar.utils.ProgressBar(5)
        ...
        sd = quasar.utils.load_torch_file(os.path.join(model_path))
        ...
        pose_net_sd = quasar.utils.load_torch_file(os.path.join(script_directory, 'models', 'mimic_motion_pose_net.safetensors'))
...
class MimicMotionGetPoses:
    ...
    def process(self, ref_image, pose_images, include_body, include_hand, include_face):
        ...
        # read input video
        pbar = quasar.utils.ProgressBar(len(pose_images_np))
