...
from quasar.sdxl_clip import SDXLClipModel, SDXLRefinerClipModel, SDXLClipG
...
def finalize_clip_regions(clip_regions, mask_token, strict_mask, start_from_masked, token_normalization='none', weight_interpretation='quasar'):
    clip = clip_regions["clip"]
    tokenizer = clip.tokenizer    
    if hasattr(tokenizer, 'clip_g'):
        tokenizer = tokenizer.clip_g
