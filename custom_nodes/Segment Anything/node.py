...
logger = logging.getLogger('quasarui_segment_anything')
...
def get_bert_base_uncased_model_path():
    quasar_bert_model_base = os.path.join(folder_paths.models_dir, 'bert-base-uncased')
    if glob.glob(os.path.join(quasar_bert_model_base, '**/model.safetensors'), recursive=True):
        print('grounding-dino is using models/bert-base-uncased')
        return quasar_bert_model_base
...
def load_sam_model(model_name):
    ...
    sam_device = quasar.model_management.get_torch_device()
