...
/*
Quasar uses 'clicked' to make the button flash; so just disable that.
...
app.registerExtension({
    ...
    async nodeCreated(node) {
        if (node?.quasarClass === "Preview Chooser" || node?.quasarClass === "Preview Chooser Fabric") {
    ...
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        if (nodeType?.quasarClass==="Preview Chooser" || nodeType?.quasarClass === "Preview Chooser Fabric") {
            ...
            nodeType.prototype.imageClicked = function (imageIndex) {
                if (nodeType?.quasarClass==="Preview Chooser") {
            ...
            nodeType.prototype.update = function() {
                ...
                if (this.send_button_widget) {
                    ...
                    } else if (FlowState.paused_here(this.id) && selection==0 && nodeType?.quasarClass === "Preview Chooser Fabric") {
                        this.send_button_widget.name = "Progress with nothing selected";
                    } else if (FlowState.idle() && selection==0 && nodeType?.quasarClass === "Preview Chooser Fabric") {
