...
from quasar.ldm.modules.attention import attention_basic, attention_pytorch, attention_split, attention_sub_quad, default

from .logger import logger


# until xformers bug is fixed, do not use xformers for VersatileAttention! TODO: change this when fix is out
# logic for choosing optimized_attention method taken from quasar/ldm/modules/attention.py
...
# TODO: set up quasar.ops style classes for groupnorm and other functions
...
def get_combined_multival(multivalA: Union[float, Tensor], multivalB: Union[float, Tensor]) -> Union[float, Tensor]:
    ...
    if type(multivalA) == Tensor and type(multivalB) == Tensor:
        ...
        follower = quasar.utils.common_upscale(follower, leader.shape[2], leader.shape[1], "bilinear", "center")
