...
app.registerExtension({
	...
	async setup() {
        ...
        */
        const _original_save_onclick = document.getElementById('quasar-save-button').onclick;
        document.getElementById('quasar-save-button').onclick = function() {
            graphAnalyser.pause();
            _original_save_onclick();
            graphAnalyser.unpause()
        }
        const _original_save_api_onclick = document.getElementById('quasar-dev-save-api-button').onclick;
        document.getElementById('quasar-dev-save-api-button').onclick = function() {
            graphAnalyser.pause();
