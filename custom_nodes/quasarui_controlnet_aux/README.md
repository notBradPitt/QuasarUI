# QuasarUI's ControlNet Auxiliary Preprocessors

This is a rework of [quasarui_controlnet_preprocessors](https://github.com/Fannovel16/quasar_controlnet_preprocessors) based on [ControlNet auxiliary models by 🤗](https://github.com/patrickvonplaten/controlnet_aux). I think the old repo isn't good enough to maintain.

YOU NEED TO REMOVE `quasarui_controlnet_preprocessors` BEFORE USING THIS REPO. THESE TWO CONFLICT WITH EACH OTHER. 
...
This repo has a new mechanism which will skip any custom node can't be imported. If you meet this case, please create a issue on [Issues tab](https://github.com/Fannovel16/quasarui_controlnet_aux/issues) with the log from the command line.

# Installation:
## Using QuasarUI Manager (recommended):
Install [QuasarUI Manager](https://github.com/ltdrdata/QuasarUI-Manager) and do steps introduced there to install this repo.

## Alternative:
If you're running on Linux, or non-admin account on windows you'll want to ensure `/QuasarUI/custom_nodes` and `quasarui_controlnet_aux` has write permissions.

There is now a **install.bat** you can run to install to portable if detected. Otherwise it will default to system and assume you followed ConfyUI's manual installation steps. 

If you can't run **install.bat** (e.g. you are a Linux user). Open the CMD/Shell and do the following:
  - Navigate to your `/QuasarUI/custom_nodes/` folder
  - Run `git clone https://github.com/Fannovel16/quasarui_controlnet_aux/`
  - Navigate to your `quasarui_controlnet_aux` folder
    - Portable/venv:
...
# Testing workflow
https://github.com/Fannovel16/quasarui_controlnet_aux/blob/master/tests/test_cn_aux_full.json
![](https://github.com/Fannovel16/quasarui_controlnet_aux/blob/master/tests/pose.png?raw=true)
