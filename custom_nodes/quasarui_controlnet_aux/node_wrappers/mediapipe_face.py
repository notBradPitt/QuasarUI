...
#Ref: https://github.com/ltdrdata/QuasarUI-Manager/blob/284e90dc8296a2e1e4f14b4b2d10fba2f52f0e53/__init__.py#L14
...
class Media_Pipe_Face_Mesh_Preprocessor:
    ...
    def detect(self, image, max_faces, min_confidence):
        ...
        #Ref: https://github.com/Fannovel16/quasar_controlnet_preprocessors/issues/70#issuecomment-1677967369
